    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                'instructions.step1': 'Click "Create Call" to start a new video call',
                'instructions.step2': 'Copy the generated offer and send it to the person you want to call',
                'instructions.step3': 'Wait for them to join and send you an answer',
                'instructions.step4': 'Paste their answer to complete the connection',
                'instructions.joinStep1': 'Get an offer from someone who created a call',
                'instructions.joinStep2': 'Paste the offer and click "Join Call"',
                'instructions.joinStep3': 'Copy the generated answer and send it back',
                'instructions.joinStep4': 'Enjoy your secure peer-to-peer video call!',
            ...
            ru: {
                ...
                'instructions.step1': 'Нажмите "Создать звонок" для начала нового видеозвонка',
                'instructions.step2': 'Скопируйте сгенерированное предложение и отправьте человеку, которому хотите позвонить',
                'instructions.step3': 'Дождитесь, пока они присоединятся и отправят вам ответ',
                'instructions.step4': 'Вставьте их ответ для завершения подключения',
                'instructions.joinStep1': 'Получите предложение от кого-то, кто создал звонок',
                'instructions.joinStep2': 'Вставьте предложение и нажмите "Присоединиться"',
                'instructions.joinStep3': 'Скопируйте сгенерированный ответ и отправьте его обратно',
                'instructions.joinStep4': 'Наслаждайтесь безопасным P2P видеозвонком!',
